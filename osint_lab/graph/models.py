...
class GraphRelationType(str, Enum):
    ...
    POSSIBLE_ACCOUNT_AT = "POSSIBLE_ACCOUNT_AT"
    OTHER = "OTHER"
...
class CaseEventType(str, Enum):
    ...
    DISCOVERY_QUERY_PLANNED = "DISCOVERY_QUERY_PLANNED"
    DISCOVERY_QUERY_EXECUTED = "DISCOVERY_QUERY_EXECUTED"
    DISCOVERY_RESULT_FOUND = "DISCOVERY_RESULT_FOUND"
    DISCOVERY_PROVIDER_FAILED = "DISCOVERY_PROVIDER_FAILED"
    TARGET_VERIFICATION_STARTED = "TARGET_VERIFICATION_STARTED"
